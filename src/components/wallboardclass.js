        ...
        .then(data => {
            ...
            .then(document => {
                var statsList = document.value;
                    ...
                    var ReservationsAccepted = statsList.workspace_statistics.cumulative.reservations_accepted
                    var TasksCanceled = statsList.workspace_statistics.cumulative.tasks_canceled
                    var AverageSpeedToAnswer = statsList.workspace_statistics.cumulative.avg_task_acceptance_time
                    var LoggedinAgents = statsList.workspace_statistics.realtime.total_workers-statsList.workspace_statistics.realtime.activity_statistics[2].workers
